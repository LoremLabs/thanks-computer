...
type Config struct {
	...
	TCPHandshakeTimeout          string   `id:"tcp-handshake-timeout" default:"5s" desc:"Bound on the TLS handshake for a ';tls' listener in --tcp-listen-addrs; a client that stalls its ClientHello is dropped. (5s)"`
