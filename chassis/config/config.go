...
type Config struct {
	...
	OpRepeatMax                  int      `id:"op-repeat-max" default:"1000" desc:"Hard cap on WITH repeat_max, the per-op pass ceiling for repeat_until loops. An op asking for more is rejected at dispatch and dropped from the merge for that request. (1000)"`
