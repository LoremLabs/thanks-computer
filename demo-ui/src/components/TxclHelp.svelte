<!-- Vendored from admin-ui's TxclHelp, trimmed to always-on content —
     the demo hosts it in a toggleable drawer that owns show/hide,
     so the component's own collapse wrapper is dropped. -->
